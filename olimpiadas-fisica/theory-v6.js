(() => {
  ...
  const theoryVisuals = window.PhysicsOlympiadTheoryVisuals;
  ...
  function render(topic){
    ...
    const visual = theoryVisuals?.render ? theoryVisuals.render(topic) : "";
    $("theoryContent").innerHTML = `
      ...
      <section class="v5-section">
        <div class="v5-section-header"><div><span class="v5-section-tag">02 · Olympiad reasoning</span><h3>Interactive concept laboratory</h3></div><span class="v5-level">Play · Pause · Compare</span></div>
    ...
    math($("theoryContent"));
    theoryVisuals?.mount?.($("theoryContent"), topic);
  }
